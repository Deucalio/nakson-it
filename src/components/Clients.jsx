...
const Clients = () => {
  ...
  return (
    <section className="px-4 py-6  border-rose-500">
      ...
      <div
        className=" mx-auto flex w-96 flex-col gap-5 px-2 py-4 md:grid md:w-full md:grid-cols-1 lg:grid-col
       h-96 w-[30rem]"
      >
        <Swiper
          ...
          modules={[Pagination]}
          className="mySwiper  w-full  lg:w-[39em] h-full"
        >
          <SwiperSlide class="">
            <article className="-ml-24 -translate-x-2 w-60 flex h-full flex-col gap-5 rounded-3xl border-sky-400 bg-[#1E1E1E] px-8 py-4">
              <img
                className="h-14 w-14"
